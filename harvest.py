...
class Melon:
    ...
    def __init__(self, melon_type, shape_rating, color_rating, harvested_field, harvested_person):
        self.melon_type = melon_type
        self.shape_rating = shape_rating
        self.color_rating = color_rating
        self.harvested_field = harvested_field
        self.harvested_person = harvested_person
...
def get_sellability_report(melons):
    ...
    for melon in melons:
        if melon.is_sellable():
            print(f'Harvested by {melon.harvested_person} from field {melon.harvested_field} CAN BE SOLD')
        else:
            print (f'Harvested by {melon.harvested_person} from field {melon.harvested_field} NOT SELLABLE')